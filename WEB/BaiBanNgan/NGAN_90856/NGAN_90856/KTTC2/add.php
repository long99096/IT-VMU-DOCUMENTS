        ...
        <div class="container">
            <form method="post">
                ...
                <fieldset class="form-group">
                    ...
                    <input type="text" name="nguoinhan" placeholder="nhap ten nhan vien" class="form-control">
                </fieldset>
                <fieldset class="form-group">
                    <label>Dien thoai</label>
                    <input type="text" name="dienthoai" placeholder="nhap so dien thoai" class="form-control">
                </fieldset>
                <fieldset class="form-group">
                    <label>Dia chi</label>
                    <input type="text" name="diachi" placeholder="nhap dia chi" class="form-control">
                </fieldset>
                <fieldset class="form-group">
                ...
                <fieldset class="form-group">
                    <label>Ghi chu</label>
                    <input type="text" name="ghichu" placeholder="ghi chu" class="form-control">
                </fieldset>
                <br>
                <fieldset class="form-group">
